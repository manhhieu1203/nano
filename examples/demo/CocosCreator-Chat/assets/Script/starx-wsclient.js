...
(function () {
  ...
  /**
   * Set Serialization for encode and decode message
   * @param {Object} s - Serialization has lookup, endcode, decode function
   */
  starx.setSerialization = function (s) {
    if (typeof s !== 'object' || s.lookup == undefined || s.encode == undefined || s.decode == undefined) {
      console.error(s, "is not a Serialization.")
      return;
    }
    Serialization = s;
  }
  ...
  var defaultEncode = starx.encode = function (reqId, route, msg) {
    ...
    if (Serialization && Serialization.lookup(route)) {
      msg = Serialization.encode(route, msg);
    } else {
  ...
  var deCompose = function (msg) {
    ...
    if (Serialization && Serialization.lookup(route)) {
      return Serialization.decode(route, msg.body);
    } else {
